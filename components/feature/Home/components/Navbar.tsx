...
const Navbar = ({ title }: NavProps) => {
  return (
    <nav className="w-[340px]">
      ...
      <h1 className=" text-black-primary uppercase text-[115px] font-primary font-[700] leading-[103.5px] mt-[12px]">the band</h1>
      <div className="w-[100%] h-[10px] bg-black-primary"></div>
      <h3 className="font-primary uppercase text-black-primary text-[31.4px] leading-[28.26px] my-[10px]">{title}</h3>
      <div className="w-[100%] h-[10px] bg-black-primary"></div>
